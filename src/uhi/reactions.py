...
Precomputed (no live AI call in the demo):
    ...
    ANTHROPIC_API_KEY=... uv run python -m uhi.reactions      # writes data/app/reactions_cache.json
"""
...
def facts(result: dict) -> str:
    ...
    return (f"Proposal: a new {result['use']} at {result['site']}. UHI estimate: it would add "
