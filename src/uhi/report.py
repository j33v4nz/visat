...
<p class="sub">{local('Kochi · UHI heat action planner · surface °C, ~10:30 AM, Jan–Apr', 'കൊച്ചി · UHI ചൂട് പ്രതിരോധ പദ്ധതി · രാവിലെ ഏകദേശം 10:30-ലെ ഉപരിതല താപനില (ജനുവരി–ഏപ്രിൽ)')}</p>
