"""Earth Engine export → data/frozen/*.parquet (M1, hours 0–4). Run once, then freeze.
    ...
    uv run python -m visat.gee_export --project <your-gee-cloud-project>
...
def era5_at(time_ms: int) -> dict:
    ...
    from visat.features import relative_humidity
...
def run(project: str):
    ...
    log("back-test composites saved — data frozen. Next: python -m visat.osm_features")
